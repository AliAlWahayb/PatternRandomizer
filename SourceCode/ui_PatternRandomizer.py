...
class Ui_PatternRandomizer(object):
    def setupUi(self, PatternRandomizer):
        
        PatternRandomizer.setObjectName("PatternRandomizer")
        PatternRandomizer.setEnabled(True)
        PatternRandomizer.resize(432, 340)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(PatternRandomizer.sizePolicy().hasHeightForWidth())
        PatternRandomizer.setSizePolicy(sizePolicy)
        PatternRandomizer.setMinimumSize(QtCore.QSize(432, 340))
        PatternRandomizer.setMaximumSize(QtCore.QSize(432, 340))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/image/die_icon31024.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        PatternRandomizer.setWindowIcon(icon)
        PatternRandomizer.setIconSize(QtCore.QSize(512, 512))
        PatternRandomizer.setAnimated(False)
        self.centralwidget = QtWidgets.QWidget(PatternRandomizer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.buttonGroup = QtWidgets.QButtonGroup(PatternRandomizer)
...
"}")
        ...
        PatternRandomizer.setCentralWidget(self.centralwidget)

        self.retranslateUi(PatternRandomizer)
        QtCore.QMetaObject.connectSlotsByName(PatternRandomizer)
        PatternRandomizer.setTabOrder(self.Btn1, self.Btn2)
        PatternRandomizer.setTabOrder(self.Btn2, self.Btn3)
        PatternRandomizer.setTabOrder(self.Btn3, self.Btn4)
        PatternRandomizer.setTabOrder(self.Btn4, self.Btn5)
        PatternRandomizer.setTabOrder(self.Btn5, self.Btn6)
        PatternRandomizer.setTabOrder(self.Btn6, self.Btn7)
        PatternRandomizer.setTabOrder(self.Btn7, self.Btn8)
        PatternRandomizer.setTabOrder(self.Btn8, self.Btn9)

    def retranslateUi(self, PatternRandomizer):
        _translate = QtCore.QCoreApplication.translate
        PatternRandomizer.setWindowTitle(_translate("PatternRandomizer", "Pattern Randomizer"))
        self.Btn7.setShortcut(_translate("PatternRandomizer", "7"))
        self.Btn9.setShortcut(_translate("PatternRandomizer", "9"))
        self.Btn2.setShortcut(_translate("PatternRandomizer", "2"))
        self.Btn4.setShortcut(_translate("PatternRandomizer", "4"))
        self.Btn8.setShortcut(_translate("PatternRandomizer", "8"))
        self.Btn5.setShortcut(_translate("PatternRandomizer", "5"))
        self.Btn6.setShortcut(_translate("PatternRandomizer", "6"))
        self.Btn1.setShortcut(_translate("PatternRandomizer", "1"))
        self.Btn3.setShortcut(_translate("PatternRandomizer", "3"))
        self.RepeatRadioButton.setText(_translate("PatternRandomizer", "Repeat"))
        self.InfiniteRadioButton.setText(_translate("PatternRandomizer", "Repeat Until Stopped"))
        self.StartBtn.setText(_translate("PatternRandomizer", "Start"))
        self.StopBtn.setText(_translate("PatternRandomizer", "Stop"))
        self.HotkeyBtn.setText(_translate("PatternRandomizer", "Save"))
        self.DelayLabel.setText(_translate("PatternRandomizer", "Delay"))
        self.NumbersLabel.setText(_translate("PatternRandomizer", "Numbers"))
        self.RepeatLabel.setText(_translate("PatternRandomizer", "Repeat"))
        self.SelectAllBtn.setText(_translate("PatternRandomizer", "Select All"))
        self.DeselectAllBtn.setText(_translate("PatternRandomizer", "Deselect All"))
        self.TimeRadioButton.setText(_translate("PatternRandomizer", "Milliseconds"))
        self.OnClickRadioButton.setText(_translate("PatternRandomizer", "On Click"))
import images
